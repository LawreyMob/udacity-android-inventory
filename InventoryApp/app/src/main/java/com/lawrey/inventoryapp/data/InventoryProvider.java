...
public class InventoryProvider extends ContentProvider {
    ...
    private static final int INVENTORY_ITEMID = 101;
    ...
    static {
        ...
        // The content URI of the form "content://com.lawrey.inventoryapp/inventory" will map to the
        ...
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORY + "/#", INVENTORY_ITEMID);
    }
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        switch (match) {
            ...
            case INVENTORY_ITEMID:
                // For the INVENTORY_ITEMID code, extract out the ID from the URI,

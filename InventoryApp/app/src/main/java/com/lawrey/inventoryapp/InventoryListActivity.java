...
public class InventoryListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InventoryListActivity.this, InventoryEditActivity.class);
        ...
        // Setup an Adapter to create a list item for each row of inventory in the Cursor.
        ...
        inventoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // For example, the URI would be "content://com.lawrey.inventoryapp/inventory/2"
    ...
    private void insertInventory() {
        ...
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_NAME, "Udacity Mug");
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_QUANTITY, 5);
        values.put(InventoryContract.InventoryEntry.COLUMN_INVENTORY_PRICE, 355.5);

        // Insert a new row for Udacity Mug into the provider using the ContentResolver.
        // Use the {@link InventoryEntry#CONTENT_URI} to indicate that we want to insert
        // into the inventory database table.
        // Receive the new content URI that will allow us to access Udacity Mug's data in the future.
